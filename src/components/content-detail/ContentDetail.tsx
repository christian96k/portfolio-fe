...
const ContentDetail: React.FC<ContentDetailProps> = ({
    ...
    return(
        <div id={id} className={`content-detail backdrop-blur-10 border-gradient rounded-3 gap-5 d-flex justify-content-md-between align-items-center row  ${order === 'left' ? 'flex-row left' : 'flex-row-reverse right'}`}>
